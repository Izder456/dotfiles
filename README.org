...
*READ THIS FILE*, they are documented in this README.org:
- [[#automation][Automation]]
...
## Only appllicable on architectures with SMT-support (e.g., amd64 or arm64).
hw.smt=0 # default 0
