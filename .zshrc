...
# Autopair
##
source ~/.zshrc.d/autopair/autopair.zsh
...
# Syntax Highlight
##
source ~/.zshrc.d/fsh/fast-syntax-highlighting.plugin.zsh

##
# History substring search
##
source ~/.zshrc.d/substring/zsh-history-substring-search.plugin.zsh
...
# Vim-mode
##
source ~/.zshrc.d/vim-mode/zsh-vim-mode.plugin.zsh
...
if command -v fzf &> /dev/null; then
    ...
    source ~/.zshrc.d/fzf-comp/zsh/fzf-zsh-completion.sh
    if [[ "$(uname)" == "OpenBSD" ]]; then
...
# 256-Color
##
source ~/.zshrc.d/256/zsh-256color.plugin.zsh
